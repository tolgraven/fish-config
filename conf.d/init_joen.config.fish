function setorset -a flags var values
	...
	or return 1
	set -l command "set $flags $var $argv[3..-1]"
	eval $command
end
# set -q blarf; or set -g blarf howdy dowdy
# setorset -g blarf howdy dowdy
...
setorset -Ux MOST_INITFILE 		"$HOME/.config/most/mostrc"
...
setorset -Ux TMUX_PLUGIN_MANAGER_PATH "$HOME/.config/tmux/plugins"
