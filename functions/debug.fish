function debug --description 'Conditional debug logger'
    ...
    echo | awk -v name="$name" -v file="$file" -v line="$line" -v time="$time" -v header="$header" -v body="$body" -v footer="$footer" '
