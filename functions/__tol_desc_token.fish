...
#### WHAT TO DO!!!!! ## look through function for other function calls and dynamically list related functions and programs. ALSO: look up like what vars are used >2-3 times, any global vars used/modified...
